...
public class OsmiumCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:osmium_coal")
	public static final Item block = null;
	public OsmiumCoalItem(MoreCoalsModElements instance) {
		super(instance, 13);
	}
