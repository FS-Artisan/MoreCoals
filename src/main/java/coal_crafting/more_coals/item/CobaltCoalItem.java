...
public class CobaltCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:cobalt_coal")
	public static final Item block = null;
	public CobaltCoalItem(MoreCoalsModElements instance) {
		super(instance, 24);
	}
