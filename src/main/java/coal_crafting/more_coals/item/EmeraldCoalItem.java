...
public class EmeraldCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:emerald_coal")
	public static final Item block = null;
	public EmeraldCoalItem(MoreCoalsModElements instance) {
		super(instance, 4);
	}
