...
public class LeadCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:lead_coal")
	public static final Item block = null;
	public LeadCoalItem(MoreCoalsModElements instance) {
		super(instance, 3);
	}
