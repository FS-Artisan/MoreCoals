...
public class QuartzCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:quartz_coal")
	public static final Item block = null;
	public QuartzCoalItem(MoreCoalsModElements instance) {
		super(instance, 6);
	}
