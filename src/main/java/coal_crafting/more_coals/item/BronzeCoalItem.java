...
public class BronzeCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:bronze_coal")
	public static final Item block = null;
	public BronzeCoalItem(MoreCoalsModElements instance) {
		super(instance, 17);
	}
