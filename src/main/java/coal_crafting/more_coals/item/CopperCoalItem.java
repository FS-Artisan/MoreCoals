...
public class CopperCoalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:copper_coal")
	public static final Item block = null;
	public CopperCoalItem(MoreCoalsModElements instance) {
		super(instance, 1);
	}
