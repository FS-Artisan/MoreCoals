...
public class CoalCrystalItem extends MoreCoalsModElements.ModElement {
	@ObjectHolder("more_coals:coal_crystal")
	public static final Item block = null;
	public CoalCrystalItem(MoreCoalsModElements instance) {
		super(instance, 21);
	}
